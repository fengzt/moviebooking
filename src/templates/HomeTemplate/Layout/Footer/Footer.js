...
export default function Footer(props) {
  ...
  const arrCumRap = _.map(arrHeThongRap, (arrRap) =>
  ...
  return (
    <footer className="px-4 divide-y bg-gray-300 text-coolGray-800">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        ...
        <div className="grid text-sm gap-x-8 gap-y-8 grid-cols-2 md:gap-x-3 md:grid-cols-4 lg:w-2/3">
          <div className="space-y-3">
            <h3
              className="tracking-wide uppercase text-coolGray-900"
              style={{ color: "#9e7e17" }}
            >
              Phim đang hot
            </h3>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              <li className="mb-3">
                <NavLink to="/contact" style={{ color: "#9a6563" }}>
                  Liên hệ
                </NavLink>
              </li>
              <li>
                <NavLink to="/application" style={{ color: "#9a6563" }}>
                  Ứng dụng
                </NavLink>
              </li>
            </ul>
          ...
          <div className="space-y-3">
            <h3
              className="uppercase text-coolGray-900"
              style={{ color: "#9e7e17" }}
            >
              Cụm rạp
            </h3>
          ...
          <div className="space-y-3">
            <div
              className="uppercase text-coolGray-900 font-bold"
              style={{ color: "#9e7e17" }}
            >
              Social media
            </div>
            <div className="flex justify-start space-x-3">
              ...
              <NavLink to="/" title="Twitter" className="flex items-center p-1">
                <svg
                  viewBox="0 0 24 24"
                  xmlns="http://www.w3.org/2000/svg"
                  className="w-5 h-5 fill-current"
      ...
      <div
        className="py-6 text-sm text-center text-coolGray-600"
        style={{ color: "#5d2a27" }}
      >
